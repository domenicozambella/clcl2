...
\begin{proof}
  ...
  The positive compactness theorem ensures the existence of $M_{i+1}$.
  We also require that all types finitely consistent in some p-elementary superstructure of some $M_i$ occurs eventually in the enumeration.
