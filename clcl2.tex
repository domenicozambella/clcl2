...
\begin{proof}
  We prove the lemma for function symbols; the general case follows by easy induction.
...
\begin{proof}
  ...
  Let $d$ be a realization of the type $\{d_n\sim_n,y:n\in\omega\}\cup p(ka,y)$.
...
\begin{proof}
  ...
  Note that well-known Ramsey's argument proves that the formulas $\psi,\tilde\psi$ in Lemma~\ref{lem_sability1} are stably separated.
