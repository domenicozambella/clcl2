...
In Section~\ref{cIelimination} we prove the analogous result for ${\EuScript L}^{\rm c}$.
...
A c-automorphism is a c-elementary map whose domain intersect all $\sim$-classes.
We define ${\EuScript L}^{\rm c}_{{\sf I}{\rm qf}}$-elementary maps in a similar manner, where (2) is required to hold only for formulas in ${\EuScript L}^{\rm c}_{{\sf I}{\rm qf}}$.
...
\begin{theorem}[Continuous Omitting Types]\label{prop_cOTT}
  Let ${\EuScript L}^{\rm c}$ be separable.
  Let $A$ be countable.
