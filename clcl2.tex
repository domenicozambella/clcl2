...
\begin{fact}
  ...
  Then the formulas $\varphi_1\wedge\dots\wedge\varphi_n$ and $\tilde\varphi_1\vee\dots\vee\tilde\varphi_n$.
\end{fact}

The following definition is derived from~\cite{Z}: the term \textit{approximable\/} not related to the topology of $I$.
A set ${\EuScript D}\subseteq{\EuScript U}^{|z|}$ is \emph{p-approximable\/} by $\varphi,\tilde\varphi$ if for every finite set $B\subseteq{\EuScript U}$ there is an $a\in{\EuScript U}^{|x|}$ such that

\ceq{{\rm iii.}\hfill B^{|z|}\ \cap\ \varphi(a\,;{\EuScript U})}{=}{B^{|z|}\, \cap\, {\EuScript D}.}

\ceq{{\rm iv.}\hfill B^{|z|}\ \cap\ \tilde\varphi(a\,;{\EuScript U})}{=}{B^{|z|}\, \smallsetminus\, {\EuScript D}.}

We say that ${\EuScript D}$ is p-approximable \emph{from below\/} if (iv) can be strengthened by requiring that

\ceq{{\rm v.}\hfill\neg{\EuScript D}}{\subseteq}{\tilde\varphi(a\,;{\EuScript U});}

We say that ${\EuScript D}$ is \emph{externally p-definable\/} by $\varphi,\tilde\varphi$ if the type below is finitely consistent

\ceq{\hfill p(x)}{=}{\big\{\varphi(x\,;b)\ :\ b\in{\EuScript D}\big\}\ \cup\ \big\{\tilde\varphi(x\,;b)\ :\ b\notin{\EuScript D}\big\}.} 

\begin{remark}
  For any $\varphi(x\,;z)\in{\EuScript L}^{\rm p}$ and ${\EuScript D}\subseteq{\EuScript U}^{|z|}$ the following are equivalent
  \begin{itemize}
    \item[1.] ${\EuScript D}$ is p-approximable by $\varphi(x\,;z)$;
    \item[2.] ${\EuScript D}$ is externally p-definable by $\varphi(x\,;z)$.
  \end{itemize}
\end{remark}
...
\begin{lemma}\label{lem_def_frombelow}
  ...
  If ${\EuScript D}$ is p-approximable by $\varphi(x\,;z)$ from below then $\neg{\EuScript D}=\psi({\EuScript U})$ where $\psi(z)=\tilde\varphi(a_1\,;z)\wedge\dots\wedge\tilde\varphi(a_n\,;z)$ for some $a_i\in{\EuScript U}^{|x|}$.
\end{lemma}
...
\begin{proof}
  ...
  \ceq{\hfill\neg{\EuScript D}}{\subseteq}{\bigcap^n_{i=0}\tilde\varphi(a_i\,;{\EuScript U})}.
  
  As the other inclusion is clear, $a_0,\dots,a_n$ are those required by the lemma.
...
\begin{proof}
  ...
  We prove that there are some $a_0,\dots,a_m$ such that $B\subseteq\varphi(a_i\,;{\EuScript U})$ for all $i\le m$ and $\neg{\EuScript D}\subseteq\tilde\psi(a_0,\dots,a_m\,;{\EuScript U})$.
  ...
  \ceq{\hfill b_n}{\in}{\bigcap^n_{i=0}\neg\tilde\varphi(a_i,{\EuScript U})\smallsetminus{\EuScript D}}
  
  If this is not possible, then
  
  \ceq{\hfill\neg{\EuScript D}}{\subseteq}{\bigcup^n_{i=0}\tilde\varphi(a_i,{\EuScript U})}
