...
\begin{definition}\label{def_0}
  ...
  We further require that ${\EuScript L}$-structures satisfy the following requirements.
...
A \emph{modulus of equicontinuity\/} of an ${\EuScript L}$-structure is a function that maps $\varepsilon$ to some $\delta$ that satisfies the condition above.
