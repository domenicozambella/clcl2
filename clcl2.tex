...
\begin{fact}\label{fact_max_cons_H}
  ...
  The following are equivalent 
  \begin{itemize}
    \item[1.] $p(x)$ is a maximally consistent subsets of ${\EuScript H}_x(A)$;
...
\begin{corollary}\label{corol_Lcomplete}
  ...
  \begin{itemize}
    \item[1.] $p(x)$ is a maximally consistent subsets of ${\EuScript H}_x(A)$;
    \item[2.] $p(x)\leftrightarrow q(x)=\mbox{p-tp}(a/A)$ for some $a\in{\EuScript U}^{|x|}$.
  \end{itemize}
\end{corollary}
...
\begin{proof}
  ...
  As every automorphism is ${\EuScript L}$-elementary, $a\equiv_Ab$, and (2) follows.
\end{proof}
...
\begin{proof}
  ...
  By Corollary~\ref{prop_LHapprox2}, there are a consistent $\varphi(x)\in{\EuScript F}(M)$ and some $\varphi'>\varphi$ such that $\varphi'(x)\rightarrow\neg\psi(x)$.
  Then (3) follows.
