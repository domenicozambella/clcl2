...
\begin{definition}\label{def_0}
  ...
  The language ${\EuScript L}$ may also contain relation symbols of sort ${\sf H}^n\times{\sf S}^m$.
...
\begin{proof}
  ...
  First note that any modulus of equicontinuity of a standard structure $M$ is also a modulus of equicontinuity of any p-elementary extension of $M$.
