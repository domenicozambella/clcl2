...
Its proof is a simple application of compactness.

\begin{corollary}\label{corol_pertubation}
  For every $\varphi(x)\in{\EuScript L}^{\rm c}({\EuScript U})$ and every $\varphi'>\varphi$ there are a tuple of terms $\tau$ and a compact neighborhood $D$ of $\Delta$ such that
