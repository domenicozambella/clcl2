...
\ceq{{\rm v.}\hfill{\EuScript D}}{\subseteq}{\varphi(a\,;{\EuScript U}).}

Dually, we say \emph{from below\/} if (iv) can be strengthened by requiring that

\ceq{{\rm vi.}\hfill\tilde{\EuScript D}}{\subseteq}{\tilde\varphi(a\,;{\EuScript U}).}


To justify the terminology, we note that in the classical case, i.e.\@ when $\tilde{\EuScript D}=\neg{\EuScript D}$ and $\tilde\varphi\leftrightarrow\varphi$, \textit{finitely separated from below\/} becomes \textit{approximated from below\/} as defined in~\cite{Z}. 
...
\begin{proof}
  ...
  We prove that there are some $a_0,\dots,a_m$ such that $B\subseteq\varphi(a_i\,;{\EuScript U})$ for all $i\le m$ and $\tilde{\EuScript D}\subseteq\tilde\psi(a_0,\dots,a_m\,;{\EuScript U})$.
  ...
  \ceq{\hfill b_n}{\in}{\bigcap^n_{i=0}\varphi(a_i,{\EuScript U})\cap\tilde{\EuScript D}}
  
  If this is not possible, then
  
  \ceq{\hfill\tilde{\EuScript D}}{\subseteq}{\neg\bigcap^n_{i=0}\varphi(a_i,{\EuScript U})}
  
  hence, setting $a_i=a_m$ for $n<i\le m$, we obtain the required $a_0,\dots,a_m$.
