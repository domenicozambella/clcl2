...
Finally, we say $\varepsilon$-approximated \emph{from below\/} if we also have

\ceq{\hfill\varphi(a\,;{\EuScript U})}{\subseteq}{{\EuScript D}_\varepsilon.}

\begin{lemma}
  Let $\varphi(x\,;z)$ be $\varepsilon$-stable.
  If ${\EuScript D}$ is $\varepsilon$-approximable by $\varphi(x\,;z)$ then ${\EuScript D}$ is $\varepsilon$-approx\-imable from below by $\varphi(x_0\,;z)\wedge\dots\wedge\varphi(x_m\,;z)$, for some $m$.
\end{lemma}
...
\begin{proof}
  ...
  \ceq{\hfill\bigcap_{i=0}^m\varphi(a_i,\,;{\EuScript U})}{\subseteq}{{\EuScript D}_\varepsilon.}
  ...
  \ceq{\hfill \{b_0,\dots,b_{n-1}\}\cup\big(B\cap\neg{\EuScript D}_\varepsilon\big)}{\subseteq}{\neg\varphi_\varepsilon(a_n\,;{\EuScript U}).}

  This is possible by (ii) and (iii).
  Now, if possible, choose $b_n$ such that

  \ceq{\hfill b_n}{\in}{\neg{\EuScript D}_\varepsilon\cap\bigcap_{i=0}^n\varphi(a_i,\,;{\EuScript U})}.
...
\begin{proof}
  ...
  \ceq{\hfill b_n}{\in}{{\EuScript D}\ \smallsetminus\ \bigcup^n_{i=0}\varphi_\epsilon(a_i\,;{\EuScript U})}.
...
\begin{lemma}\label{lem_apx_frombelow}
  ...
  Let ${\EuScript D}$ be approximable by $\varphi(x\,;z)$.
  Then the formula 
